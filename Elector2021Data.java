...
* Here will be a new Interface implementation.
*
...
* @version 1.0
* @since   2021-05-30 
* @implements Comparable Interface with the sake of get a List sorted.
* 
*/

class Elector2021Data implements Comparable<Elector2021Data>{
	...
	*/	
	...
	/** 
	*	Method from Comparable interface. String class implements 
	*	Comparable interface as well.
	*	@param Elector2021Data object.
	*	@returns an int indicating the difference of both values.
	*/
	public int compareTo(Elector2021Data elect){
		return this.Id_Number.compareTo(elect.Id_Number);
	}
}